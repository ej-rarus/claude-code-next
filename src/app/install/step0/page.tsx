  ...
  return (
    <>
      ...
      <div style={{ marginTop: '32px' }}>
        <h3 style={{ fontSize: '1.5rem', marginBottom: '24px', color: 'var(--text-primary)' }}>뭘 설치하는 건가요?</h3>
      ...
      <div style={{ marginTop: '48px' }}>
        <h3 style={{ fontSize: '1.5rem', marginBottom: '24px', color: 'var(--text-primary)' }}>Claude Code, 왜 사용해야 하나요?</h3>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', marginTop: '24px' }}>
          <div className="card" style={{ background: 'var(--bg-secondary)', border: '1px solid var(--border-color)', padding: '24px', borderRadius: '12px' }}>
            ...
            <h3 style={{ fontSize: '1.1rem', marginBottom: '12px', color: 'var(--text-primary)' }}>웹 버전 Claude</h3>
          ...
          <div className="card" style={{ background: 'linear-gradient(135deg, rgba(99, 102, 241, 0.2), rgba(139, 92, 246, 0.2))', border: '2px solid var(--primary)', padding: '24px', borderRadius: '12px', position: 'relative' }}>
            ...
            <h3 style={{ fontSize: '1.1rem', marginBottom: '12px', color: 'var(--text-primary)' }}>로컬 Claude Code</h3>
            <ul style={{ color: 'var(--text-primary)', fontSize: '0.95rem', lineHeight: '1.8' }}>
        ...
        <div style={{ marginTop: '32px' }}>
          <h4 style={{ fontSize: '1.2rem', marginBottom: '16px', color: 'var(--text-primary)' }}>실제 사용 예시</h4>
          <div style={{ background: 'var(--bg-secondary)', borderRadius: '12px', padding: '24px', borderLeft: '4px solid var(--success)' }}>
            <p style={{ color: 'var(--text-primary)', fontWeight: 500, marginBottom: '16px' }}>상황: 프로젝트 폴더에 있는 10개의 Markdown 파일을 모두 읽고 하나의 보고서로 정리하고 싶다면?</p>

            <div style={{ display: 'grid', gap: '16px' }}>
              <div>
                <p style={{ color: '#ef4444', fontWeight: 600, marginBottom: '8px' }}>웹 Claude</p>
                <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem' }}>1. 파일 10개를 찾아서 업로드<br/>2. AI가 분석<br/>3. 결과를 복사해서 새 파일에 붙여넣기<br/>4. 파일을 저장하고 관리</p>
              </div>

              <div>
                <p style={{ color: 'var(--success)', fontWeight: 600, marginBottom: '8px' }}>Claude Code</p>
                <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem' }}>1. "이 폴더의 모든 .md 파일을 읽고 report.md로 정리해줘" 한 줄 입력<br/>2. 끝! (AI가 파일을 찾아 읽고, 정리하고, 저장까지 자동으로 완료)</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="tip-box success" style={{ marginTop: '48px' }}>
        ...
        <div className="tip-content">
          <h4>준비되셨나요?</h4>
          <p>이제 <span className="emphasis">패키지 관리자 설치</span>부터 시작해봅시다!</p>
        </div>
      </div>
