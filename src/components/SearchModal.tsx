...
const searchItems: SearchItem[] = [
  ...
  // 플랫폼 & 연동
  {
    ...
    label: 'Desktop 앱',
    category: '플랫폼 & 연동',
    description: 'Claude Code Desktop 앱 설치 및 사용',
    keywords: ['데스크톱', 'desktop', '앱', 'app', 'diff', 'PR', '권한', '설치', 'Electron', '프리뷰'],
  },
  {
    href: '/code-web',
    icon: 'fa-cloud',
    label: '웹에서 Claude Code',
    category: '플랫폼 & 연동',
    description: '브라우저에서 Claude Code 사용하기',
    keywords: ['웹', 'web', 'claude.ai/code', '브라우저', '클라우드', '--remote', '--teleport', '텔레포트', 'PR', 'GitHub'],
  },
  {
    href: '/remote-control',
    icon: 'fa-wifi',
    ...
    category: '플랫폼 & 연동',
    description: '다른 기기에서 로컬 세션 원격 제어',
    keywords: ['리모트', 'remote', '원격', 'QR', '코드', '모바일', '폰', '태블릿', '원격 제어'],
  },
  {
    href: '/chrome',
    icon: 'fab fa-chrome',
    label: 'Chrome 연동',
    category: '플랫폼 & 연동',
    description: 'Chrome 브라우저를 Claude가 직접 제어',
    keywords: ['크롬', 'chrome', '브라우저', '디버깅', 'DOM', '콘솔', '확장', 'extension', 'Edge', 'GIF'],
  },
  {
    href: '/slack',
    icon: 'fab fa-slack',
    label: 'Slack 연동',
    category: '플랫폼 & 연동',
    description: 'Slack에서 @Claude 멘션으로 코딩 작업',
    keywords: ['슬랙', 'slack', '멘션', 'mention', '채널', '채팅', '버그', '라우팅', '워크스페이스'],
  },
  // 고급 기능 (추가)
  {
    href: '/fast-mode',
    ...
    label: 'Fast Mode',
    category: '고급 기능',
    description: 'Opus 4.6 응답 속도 2.5배 향상',
    keywords: ['패스트', 'fast', '빠른', '속도', 'speed', '/fast', '토글', '비용', 'rate limit'],
  },
  {
    href: '/sandboxing',
    icon: 'fa-shield-alt',
    label: '샌드박싱',
    category: '고급 기능',
    description: 'OS 수준 파일/네트워크 격리 보안',
    keywords: ['샌드박스', 'sandbox', '격리', '보안', 'security', 'Seatbelt', 'bubblewrap', '파일 시스템', '네트워크', '/sandbox'],
  },
  {
    ...
    label: '예약 작업 (/loop)',
    category: '고급 기능',
    description: '프롬프트 반복 실행 및 예약',
    keywords: ['예약', 'schedule', 'loop', 'cron', '반복', '타이머', '알림', 'reminder', '모니터링'],
  },
  {
    href: '/checkpointing',
    icon: 'fa-history',
    label: '체크포인팅',
    category: '고급 기능',
    description: '코드 변경 추적 및 되돌리기',
    keywords: ['체크포인트', 'checkpoint', 'rewind', '되돌리기', 'undo', '복원', 'restore', '요약', 'summarize', 'Esc'],
  },
  // 확장 & 도구 (추가)
  {
    href: '/sub-agents',
    ...
    label: '서브에이전트',
    category: '확장 & 도구',
    description: '특화된 AI 도우미로 작업 분배',
    keywords: ['서브에이전트', 'subagent', 'sub-agent', '에이전트', 'agent', 'Explore', 'Plan', '/agents', '병렬', '모델'],
  },
  {
    href: '/agent-teams',
    icon: 'fa-users',
    label: 'Agent Teams',
    category: '확장 & 도구',
    description: '여러 Claude 인스턴스가 팀으로 협업',
    keywords: ['에이전트 팀', 'agent team', '팀', 'team', '협업', '병렬', '팀원', 'teammate', 'tmux', '리더'],
  },
  {
    href: '/plugins',
    ...
    label: 'Plugins',
    category: '확장 & 도구',
    description: 'Skills/에이전트/Hooks를 패키지로 공유',
    keywords: ['플러그인', 'plugin', '패키지', '마켓플레이스', '공유', '배포', 'plugin.json', '확장'],
  },
  // 레퍼런스
  {
    href: '/examples',
